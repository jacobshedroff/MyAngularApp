...
public class Application implements CommandLineRunner{
    ...
    public void run(String... strings)throws Exception {
        ...
        jdbcTemplate.execute("CREATE TABLE movies(" +
                "id SERIAL, title VARCHAR(255), year YEAR, genre_id INT)");
        ...
        log.info("Querying for movie records where first_name = 'Josh':");
        jdbcTemplate.query(
                "SELECT id, title, movie_year FROM customers WHERE title = ?", new Object[] { "Arrival" },
